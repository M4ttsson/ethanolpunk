                        ...
                        if (sp.SpawnTriggerRect.Contains((int)player.torso.Position.X, (int)player.torso.Position.Y))
                        {
                            switch (sp.Id)
                            {
                                case 1:
                                    ...
                                    theAI.Add(new AI(world, enemyTurret, new Vector2(65, 68), sp.SpawnPositions[1], 100, 20, this, AI.Behavior.Turret, "enemy"));
                                    break;
                                ...
                                case 4:
                                    theAI.Add(new AI(world, enemyTurret, new Vector2(65, 68), sp.SpawnPositions[0], 100, 20, this, AI.Behavior.Turret, "enemy"));
                                ...
                                case 5:
                                    theAI.Add(new AI(world, enemyTexture, new Vector2(42, 90), sp.SpawnPositions[0], 100, 20, this, AI.Behavior.PatrolDistance, "enemy"));
                                    theAI.Add(new AI(world, enemyTexture, new Vector2(42, 90), sp.SpawnPositions[1], 100, 20, this, AI.Behavior.PatrolDistance, "enemy"));
                                    theAI.Add(new AI(world, enemyTurret, new Vector2(65, 68), sp.SpawnPositions[2], 100, 20, this, AI.Behavior.Turret, "enemy"));
                                    theAI.Add(new AI(world, enemyTurret, new Vector2(65, 68), sp.SpawnPositions[3], 100, 20, this, AI.Behavior.Turret, "enemy"));
                                    break;
